...
This toolset is currently designed to be run entirely through code, with the functional, and character-specific build 
  code split into their own files.
...
- ### (In Progress) Digitigrade Leg (4 bone leg, e.g. Dog legs)  (`$`)
  - ![#D9743B](https://placehold.co/15x15/D9743B/D9743B.png) (Requires fixing) FKIK
